...
//        self.playerLayer.videoGravity = AVLayerVideoGravityResize;
        ...
        [self.progressSlider setMinimumTrackImage:[UIImage imageNamed:@"Perform_detail_record_minimum"] forState:UIControlStateNormal];
        [self.progressSlider setMaximumTrackImage:[UIImage imageNamed:@"Perform_detail_record_maximum"] forState:UIControlStateNormal];
